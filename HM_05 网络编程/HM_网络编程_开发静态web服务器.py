...
def connect(request_tcp_socket):
...
def main():
    ...
    while True:
        # 4. 接收连接请求，并解码
        request_tcp_socket, ip_port = tcp_server_socket.accept()
        connect_thread = threading.Thread(target=connect, args=(request_tcp_socket,))
        # 设置守护主线程
